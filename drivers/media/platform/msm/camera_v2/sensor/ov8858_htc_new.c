...
#define ov8858_SENSOR_NAME "ov8858_htc_new"
#define PLATFORM_DRIVER_NAME "msm_camera_ov8858_htc_new"
#define ov8858_obj ov8858_htc_new_##obj
...
static const struct of_device_id ov8858_dt_match[] = {
	{.compatible = "htc,ov8858_htc_new", .data = &ov8858_s_ctrl},
	{}
};
	...
	struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	if (cdata != NULL) {
		...
		pr_info("OV8858: first fuse->fuse_id : 0x%x 0x%x 0x%x 0x%x\n",
		  0,
		  otp[5],
		  otp[6],
		  otp[7]);
...
MODULE_DESCRIPTION("ov8858_htc_new");
